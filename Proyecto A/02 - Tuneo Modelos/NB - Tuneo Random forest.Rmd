...
```{r}
plot(ridge, xvar = "min.node.size")
```

```{r}
ggplot(df_results, aes(x=min.node.size, y = ROC,color=as.factor(mtry)))+
  geom_point()+
  geom_line()+
...
```{r}
write_csv(ridge$results, file ="C:/Users/kiri/Documents/GitHub/Proyecto_CDD/Proyecto A/02 - Tuneo Modelos/Random Forest/Resultados_RF.csv",append=T)
```

```{r}
df_results <- read_csv("C:/Users/kiri/Documents/GitHub/Proyecto_CDD/Proyecto A/02 - Tuneo Modelos/Random Forest/Resultados_RF.csv")
