...
```{r}
plot(ridge, xvar = "mtry")
```

```{r}
ggplot(ridge$results, aes(x=min.node.size, y = Accuracy,color=as.factor(mtry)))+
  geom_point()+
  geom_line()+
...
```{r}
getwd()
write_csv(ridge$results, file ="C:/Users/kiri/Documents/GitHub/Proyecto_CDD/Proyecto A/02 - Tuneo Modelos/Random Forest/Resultados_RFkiri.csv")
```
