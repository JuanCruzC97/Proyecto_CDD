...
```{r}
ggplot(lasso$results, aes(x=lambda, y = Accuracy))+
  geom_point()+
  geom_line()+
...
```{r}
#write_csv(lasso$results, file = "Proyecto A/02 - Tuneo Modelos/Logisticos/lasso/lasso.csv")
```

```{r}
df_results <- read_csv("Proyecto A/02 - Tuneo Modelos/Logisticos/lasso/lasso.csv")
df_results <- rbind(df_results, lasso$results)
write_csv(df_results, file = "Proyecto A/02 - Tuneo Modelos/Logisticos/lasso/lasso.csv")
```
